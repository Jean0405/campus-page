...
function HeaderHome() {
  return (
    <div className='relative flex flex-col items-center justify-center gap-5 p-5 bg-center' style={{ backgroundImage: 'url("https://pbs.twimg.com/media/F6aSTIBW8AA2UsI?format=jpg&name=4096x4096")', backgroundSize: 'cover', backgroundPosition: 'center', height:'450px' }}>
